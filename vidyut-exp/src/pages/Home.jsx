    ...
    <div className="min-h-screen">
      ...
      <section className="py-8 sm:py-10 px-4 bg-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          />
          <p
            className="text-lg sm:text-xl mb-4 px-4"
      ...
      <section className="py-10 sm:py-14 px-4 bg-white">
        <div className="max-w-6xl mx-auto animate-fade-in-up">
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-center mb-6 sm:mb-8 text-slate-800">
            Who Should Attend?
          </h2>
          ...
          {/* <div className="flex justify-center mt-4 sm:mt-6">
            <div className="max-w-xs">
              ...
              >
                <video
                  src={targetAudience[targetAudience.length - 1].icon}
                  autoPlay
                  loop
                  muted
                  playsInline
                ...
                />
                <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-slate-900">
                  {targetAudience[targetAudience.length - 1].name}
                </h3>
              </div>
            </div>
          </div> */}
